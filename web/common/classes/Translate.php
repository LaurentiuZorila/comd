...
class Translate
{
    ...
    private static function langRO()
    {
        return [
            ...
            'Download_file_from'    => 'File-ul pentru tabelele create de tine descarca-l de aici',
            'Download_file_from_common' => 'File-ul pentru tabelele comune(concediu, medical, etc...) descarca-l de aici',
            'File'              => 'File',
            ...
            'completed_csv_file'    => 'File-ul trebuie completat ca in exemplul afisat mai jos. <br /> Mai sus exista doua tipuri de file-uri, un file este pentru a adauga datele pentru tablele comune(concediu, zile neplatite, medical, etc.) si al doilea file este pentru tabele individuale create de voi.',
            ...
            'cancel'            => 'Sterge',
            'calendar'          => 'Calendar',
            'download_generated_file'   => 'Rog a folosi file-ul generat de noi. Pentru a descarca file-ul apasa butonul de INFO prezent in dreapta',
            'add_employees'             => 'Adauga useri',
            'insert_employee_template'  => 'Fisierul trebuie sa continta doua coloane (First Name si Last Name). Template-ul il poti descarca de aici',
            'change_status'             => 'Status operator',
            'edit_employee'             => 'Editeaza muncitori',
            'Status'                    => 'Status',
            'avaible'                   => 'Lucreaza',
            'dismissed'                 => 'Demis',
            ...
            'edit'                      => 'Editeaza',
            'delete'                    => 'Sterge',
            'status_success_updated'    => 'Statusul a fost schimbat cu succes',
            'employee_deleted'          => 'Userul a fost sters cu success',
            'delete_confirmation'       => 'Sigur vrei sa stergi?',
            'show_graph'                => 'Arata grafic',
            'best_details'              => 'Apasa butonul din dreapta pentru a vizualiza datele despre cel mai bun operator',
            'best_details_second'       => 'Rezultatele sunt calculate in functie de datele introduse in configurarea profilului',
            'best_details_tree'         => 'Dedesupt sunt afisate configurarile tabelelor',
            'your_configuration'        => 'Configuratia tabelelor',
            'tables_priority'           => 'Prioritatea tabelelor',
            'tables_data_visualisation'        => 'Visualizarea datelor',
            'tables_conditions'         => 'Conditia tabelelor',
    ...
    {
        return [
            'navNotification'   => 'New data has been added',
            ...
            'Download_file_from'        => 'File for tables created by yourself download it from here',
            'Download_file_from_common' => 'File for common tables(vacation, medical leaves, etc..) download it from here',
            'File'              => 'File',
            ...
            'calendar_info_lead'        => 'Here appear all request from your employees (accepted, denied or pending requests). <br /> You can accept or delete employees requests.',
            'upload'            => 'Upload',
            ...
            'ID'                => 'id',
            'completed_csv_file'    => 'File must be completed like example displayed below. <br /> Above exists two tipes of files, one file is to insert records in common tables like(vacation, unpaid days, medical leaves, eg.) and another is to insert records in tables created by yourself.',
            ...
            'delete'            => 'Delete',
            'calendar'          => 'Calendar',
            'download_generated_file'   => 'Please use file generated by us, to download it click right info button.',
            'add_employees'             => 'Add employees',
            'insert_employee_template'  => 'File need to contain two collumns(First Name and Last Name). Download file template from here',
            'change_status'             => 'Employees status',
            ...
            'edit'                      => 'Edit',
            'status_success_updated'    => 'Status has been successfully updated',
            ...
            'tables_priority'           => 'Priority table',
            'tables_data_visualisation'        => 'Data visualisation',
            'tables_conditions'         => 'Tables condition',
    ...
    private static function langIT()
    {
        return [
            ...
            'Download_file_from'        => 'Files per tabele creati da te scarica da qui',
            ...
            'from'              => 'da',
            'notification_not_found'    => 'Non risultano notiffiche',
            ...
            'completed_csv_file'    => 'File deve essere compilato come il essempio presente in basso. <br />  Sopra risulano due tipo di file, uno è per inserire dati per le tabele comune(ferie, permeso, malatia, etc.) e un altro per inserire dati in tabele create da voi.',
            ...
            'cancel'            => 'Cancella',
            'calendar'          => 'calendario',
            'download_generated_file'   => 'Si prega di usare il file generato da noi. Per scaricare il file clicca su info butone presente a destra',
            'add_employees'             => 'Inserisci operatori',
            'insert_employee_template'  => 'File deve contenere due collone(First Name e Last Name). Scarica file template da qui',
            'change_status'             => 'Stato operatore',
            'edit_employee'             => 'Modifica operatore',
            'Status'                    => 'Stato',
            'avaible'                   => 'In forza',
            'dismissed'                 => 'Dimiss',
            'maternity'                 => 'Maternità',
            ...
            'edit'                      => 'Modifica',
            'delete'                    => 'Cancella',
            'status_success_updated'    => 'Stato è stato cambiato con successo',
            'employee_deleted'          => 'Utente è stato cancellato',
            'delete_confirmation'       => 'Sicurro voi procedere con la cancellazione?',
            'show_graph'                => 'Vedi grafico',
            'best_details'              => 'Clicca sul buttone presente in destra per visualizare i dati del best operatore',
            'best_details_second'       => 'Risultati sono calculati secondo dei dati inseriti nel primo steep in configuazione del profilo',
