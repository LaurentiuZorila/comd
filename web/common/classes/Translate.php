...
class Translate
{
    ...
    private static function langEN()
    {
        return [
            ...
            'ID'                => 'id',
            'completed_csv_file'    => 'File must be completed like example displayed below. <br /> Above exists two tipes of files, one file is to insert records in common tables like(vacantion, unpaid days, medical leaves, eg.) and another is to insert records in tables created by yourself.',
