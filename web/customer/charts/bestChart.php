        ...
        data: {
            labels: <?php echo $best->chartData(['name'], true, false); ?>,
                datasets: [
                {
                    ...
                    fill: true,
                    lineTension: 0,
                    backgroundColor: [<?php echo $best->chartColors(); ?>],
                    borderColor: [<?php echo $best->chartColors(); ?>],
                    borderCapStyle: 'butt',
                    borderDash: [],
                ...
                },
                {
                    ...
                    fill: true,
                    lineTension: 0,
                    backgroundColor: [<?php echo $best->chartColors(false); ?>],
                    borderColor: [<?php echo $best->chartColors(false); ?>],
                    borderCapStyle: 'butt',
                    borderDash: [],
                    borderDashOffset: 0.0,
                    borderJoinStyle: 'miter',
