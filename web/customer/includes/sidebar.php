...
<nav id="sidebar">
    ...
    <ul class="list-unstyled">
        ...
        <li><a href="tables.php"> <i class="fa fa-users"></i><?php echo Translate::t('All_employees'); ?></a></li>
        <li><a href="user_data.php"> <i class="fa fa-line-chart"></i><?php echo Translate::t( 'Employees_details'); ?></a></li>
...
<!--        <li><a href="charts.php"> <i class="fa fa-bar-chart"></i>Data charts </a></li>-->
        <li><a href="#update" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i><?php echo Translate::t('Update_db'); ?></a>
            <ul id="update" class="collapse list-unstyled ">
                <li><a href="update_database.php"><i class="icon-dashboard"></i><?php echo Translate::t('Update_db'); ?></a></li>
                <li><a href="update_users_profile.php"> <i class="icon-user"></i><?php echo Translate::t('Update_employees_profile'); ?> </a></li>
                <li><a href="add_users.php"> <i class="fa fa-user-plus"></i><?php echo Translate::t('add_user'); ?> </a></li>
            </ul>
        </li>
        <li><a href="#profile" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i><?php echo Translate::t('Profile'); ?> </a>
            <ul id="profile" class="collapse list-unstyled ">
                <li><a href="update_profile.php"><i class="icon-settings"></i><?php echo Translate::t('my_profile'); ?></a></li>
