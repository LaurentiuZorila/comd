...
<nav id="sidebar">
    ...
    <ul class="list-unstyled">
        ...
        <li><a href="tables.php"> <i class="fa fa-users"></i><?php echo Translate::t($lang, 'All_employees'); ?></a></li>
        <li><a href="user_data.php"> <i class="fa fa-line-chart"></i><?php echo Translate::t($lang, 'Employees_details'); ?></a></li>
